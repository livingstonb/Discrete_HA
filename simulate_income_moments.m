...
for i = 1:4
    ...
    yTsim{i} = yTgrid(yTindsim);
    yPsim{i} = yPgrid(yPindsim);
end
...
for i = 1:4
    ...
    Qmoments(i).yT_mu1 = mean(logyTsimQ);
    Qmoments(i).yT_mu2 = mean( (logyTsimQ - mean(logyTsimQ)).^2 );
    Qmoments(i).yT_mu3 = mean( (logyTsimQ - mean(logyTsimQ)).^3 );
    Qmoments(i).yT_mu4 = mean( (logyTsimQ - mean(logyTsimQ)).^4 );
    ...
    Qmoments(i).yP_mu1 = mean(logyPsimQ);
    Qmoments(i).yP_mu2 = mean( (logyPsimQ - mean(logyPsimQ)).^2 );
    Qmoments(i).yP_mu3 = mean( (logyPsimQ - mean(logyPsimQ)).^3 );
    Qmoments(i).yP_mu4 = mean( (logyPsimQ - mean(logyPsimQ)).^4 );
end
...
for i = 1:4
    ...
    yPsimA = sum(yPsimA{i},2);
    Amoments(i).yT_mu1 = mean(yPsimA);
    Amoments(i).yT_mu2 = mean( (yPsimA - mean(yPsimA)).^2 );
    Amoments(i).yT_mu3 = mean( (yPsimA - mean(yPsimA)).^3 );
    Amoments(i).yT_mu4 = mean( (yPsimA - mean(yPsimA)).^4 );
    
    logyPsimA = log(yPsimA);
    Amoments(i).yT_mu1 = mean(logyPsimA);
    Amoments(i).yT_mu2 = mean( (logyPsimA - mean(logyPsimA)).^2 );
    Amoments(i).yT_mu3 = mean( (logyPsimA - mean(logyPsimA)).^3 );
    Amoments(i).yT_mu4 = mean( (logyPsimA - mean(logyPsimA)).^4 );
end
